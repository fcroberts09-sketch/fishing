              ...
              <div style={{background:C.card,borderRadius:14,border:editMode?'2px solid '+C.amber:'1px solid '+C.bdr,overflow:'hidden',position:'relative'}}>
                ...
                <div style={{height:500,position:'relative'}}>
                  <MapContainer center={bayConfig.center} zoom={bayConfig.zoom} style={{height:'100%',width:'100%'}} zoomControl={false} key={selBay.id}>
                    ...
                    <MapClickHandler onRightClick={handleMapRightClick} onLeftClick={handleMapLeftClick} editMode={editMode} />
                  ...
                  {ctxMenu && editMode && <div style={{position:'absolute',left:Math.min(ctxMenu.x+14,250),top:ctxMenu.y+52,zIndex:1000,background:C.card,border:'1px solid '+C.bdr2,borderRadius:12,padding:6,minWidth:180,boxShadow:'0 8px 32px #000a'}} onMouseDown={e=>e.stopPropagation()} onClick={e=>e.stopPropagation()}>
                ...
                {editPopup && editMode && <div ref={editPanelRef} style={{background:C.card,border:'1px solid '+C.bdr2,borderRadius:14,overflow:'hidden',marginTop:8}} onMouseDown={e=>e.stopPropagation()} onClick={e=>e.stopPropagation()}>
                  ...
                  <div style={{padding:16}}>
                    ...
                    <div style={{display:'flex',gap:8,marginTop:16}}>
                      <Btn primary small style={{flex:1}} onClick={()=>{showT('Saved!');setEditPopup(null);}}><ChkI s={14} c={C.bg}/> Done</Btn>
                      <Btn small danger onClick={()=>handleDeleteMarker(editPopup.type,editPopup.id)}><TrashI s={14}/> Delete</Btn>
                    </div>
                  </div>
                </div>}
